...
class CategoriasControlador extends Controlador 
{
    private $usuario = "";
    private $modelo = "";
    private $sesion;
    ...
    public function alta()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            //aplica método cadena() a categoria del POST, para sanitizar, por seguridad, 
        ...
        if (!empty($errores) || $_SERVER['REQUEST_METHOD'] != "POST") {
            ...
            $datos = [
                "titulo" => "Alta  Categorías",
                "subtitulo" => "Alta de nueva Categoría",
                "activo" => "categorias",
                "menu" => true,
                "admon" => true,
                "errores" => $errores,
