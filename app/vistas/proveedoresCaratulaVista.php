...
<div class="table-responsive">
    ...
    <tbody>
        ...
        for($i=0; $i<count($datos['data']); $i++) {
            print "<tr>";
                ...
                print "<td><a href='".RUTA."ProveedoresControlador/modificar/".$datos["data"][$i]["id"]."/".$datos["pag"]["pagina"]."' class='btn btn-info'>Modificar</a></td>";
                //el enlace lo envia por url, al método eliminar, de PaisesControlador, con los parámetros "id" y "página"
                print "<td><a href='".RUTA."ProveedoresControlador/eliminar/".$datos["data"][$i]["id"]."/".$datos["pag"]["pagina"]."'  class='btn btn-danger'>Eliminar</td>";
            print "</tr>";
        }
        ?>
    </tbody>
    ...
    <a href="<?php print RUTA;?>ProveedoresControlador/alta/" class="btn btn-success">Nuevo Proveedor</a>
</div>
